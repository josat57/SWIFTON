...
public class SwiftPermissions {

    private static final String TAG = SwiftPermissions.class.getSimpleName();
    ...
    public static void init(Context context) {
        sharedPreferences = context.getSharedPreferences("swifton.swifton.runtimepermissionhelper", Context.MODE_PRIVATE);
        SwiftPermissions.context = context;
    }
